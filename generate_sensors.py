...
The EC2 service and some deployment scripts still invoke generate_sensors.py.
Keep this thin wrapper so those entry points continue to work after the rename
to Fog_node.py.
"""
